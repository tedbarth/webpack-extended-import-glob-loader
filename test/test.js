  ...
  describe('from files', () => {
    ...
    describe('import modules from "*.js"', () => {
      it('should expand glob import files', () => {
        ...
        expect(generatedCode).to.equal(
          'import * as modules0 from "./modules/a.js"; import * as modules1 from "./modules/b.js"; import * as modules2 from "./modules/c.js"; const modules = [{fileName: "./modules/a.js", module: modules0}, {fileName: "./modules/b.js", module: modules1}, {fileName: "./modules/c.js", module: modules2}];'
        );
      });
    });
